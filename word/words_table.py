# https://github.com/RadiantCoding/Code/blob/master/Word%20Doc%20-%20Simple%20Table.py

# https://www.youtube.com/watch?v=so2illANiRw&t=20s
# https://www.youtube.com/watch?v=rnp4QOLP9iM
# https://docs-python.ru/packages/modul-python-docx-python/izmenenie-maketa-dokumenta/
# 
import docx
import os
